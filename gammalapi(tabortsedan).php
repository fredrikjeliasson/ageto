...
function getDevices($type)
{
    ...
    while ($row = $results->fetchArray()) {
        ...
        if ($starred == '1') {
            ...
            echo "<a href=\"#\" class=\"$device_id\"  onClick=\"loadAPI('api.php?loadContent=starDevice&id=$device_id')\">$IconStarred</a>";
            
        } elseif ($starred < '1') {
            
            echo "<a href=\"#\" class=\"$device_id\" onClick=\"loadAPI('api.php?loadContent=starDevice&id=$device_id')\">$IconStar</a>";
		...
		echo "<div class=\"linkToAPIButtonRight\" href=\"#\" onClick=\"loadAPI('api.php?deviceId=$device_id&action=Off&current=$current')\"><div class=\"centeredDIV $device_id $classR\">$lang_off</div></div>"; //Add DIV and CSS here ON-button					
	...
	// echo "<script>$(\"body\").css(\"display\",\"inline\");</script>"
